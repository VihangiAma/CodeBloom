...
export default function Home() {
  ...
  const sections = [
    { src: mechanical, alt: "Mechanical Section", title: "Mechanical Section", path: "/sections/mechanical" },
    { src: bodyshop, alt: "Bodyshop Section", title: "Bodyshop Section", path: "/sections/bodyshop" },
    { src: electrical, alt: "Electrical Section", title: "Electrical Section", path: "/sections/electrical" },
    { src: service, alt: "Vehicle Service Section", title: "Vehicle Service Section", path: "/sections/service" },
  ];
  const experts = [

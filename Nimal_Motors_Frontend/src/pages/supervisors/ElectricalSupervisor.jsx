...
//     try {
//       const res = await axios.get("http://localhost:5000/api/user/electrical/profile", {
//         headers: { Authorization: `Bearer ${user.token}` },
//       });
//       console.log("Fetched profile data:", res.data); // debug
//       setProfile(res.data?.user || {}); // ✅ Safe fallback
//     } catch (err) {
...
//     setIsEditing(false);
//     try {
//       await axios.post("http://localhost:5000/api/user/electrical/profile", profile);
...
//               Hi, I’m {profile.fullName || "—"}. As the Electrical&nbsp;Supervisor at
//               Nimal Motors I’m responsible for diagnosing and repairing complex
//               auto‑electrical systems—from advanced ECU fault tracing to high‑voltage
//               hybrid drivetrains. I coordinate the workflow for our electrical bay,
//               ensure every repair meets OEM safety specs, and train technicians on the
//               latest diagnostic tools and wiring‑repair techniques. My goal is to keep
//               every vehicle’s electrical and electronic systems running at peak
//               efficiency while delivering a customer experience that’s as reliable as
//               the work we do. Outside the workshop you’ll catch me poring over new EV
//               schematics or running hands‑on safety drills for the team.
//             </p>
//           </section>

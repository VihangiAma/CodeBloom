      ...
      {isEditing ? (
        ...
        <div className="overflow-x-auto">
          <table className="min-w-full table-auto border-separate border-spacing-0">
            ...
            <tbody className="text-sm text-gray-700">
              {filteredAppointments.map((appointment) => (
                <tr key={appointment.serviceID} className="hover:bg-gray-100">
                  <td className="border px-4 py-2">{appointment.serviceID}</td>
                  <td className="border px-4 py-2">{appointment.customerName}</td>
                  <td className="border px-4 py-2">{appointment.vehicleNumber}</td>
                  <td className="border px-4 py-2">
                  ...
                  <td className="border px-4 py-2">
                    {updatingStatusId === appointment.serviceID ? (
                      <ImSpinner2 className="animate-spin text-blue-500 text-2xl mx-auto" />
                    ) : (
                      <select
                        value={appointment.status}
                        onChange={(e) =>
                        ...
                        className={`border border-gray-300 rounded-md px-2 py-1 text-sm w-full focus:outline-none focus:ring-2 focus:ring-blue-400 ${getStatusColor(
                          appointment.status
                        )}`}
                      >
                        <option value="Pending">Pending</option>

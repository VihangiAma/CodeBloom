        ...
        <tbody>
          {appointments.map((appointment) => (
            <tr key={appointment._id} className="text-center">
              ...
              <td className="px-4 py-2 border">{appointment.contact.email}</td>
...
//         text: "The appointment has been approved and the customer has been notified via email.",
//       });
//     } catch (error) {
//       console.error(error);
//       Swal.fire({
...
//         text: "The appointment has been rejected and the customer has been notified via email.",
//       });
//     } catch (error) {
//       console.error(error);
//       Swal.fire({

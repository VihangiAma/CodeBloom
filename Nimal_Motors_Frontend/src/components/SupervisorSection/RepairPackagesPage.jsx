...
//     const updatedRepairs = [...pkg.repairs, { label: newRepairText, price: 0 }];
//     try {
//       await axios.put(`http://localhost:5001/api/repair-packages/${pkg._id}`, {
//         repairs: updatedRepairs,
//       });
...
//   const handlePriceChange = async (pkg, index, price) => {
//     // Only allow price update for Full Service
//     if (pkg.packageName !== "Full Service") return;

//     const updatedRepairs = pkg.repairs.map((r, i) =>
//       i === index ? { ...r, price: Number(price) || 0 } : r
//     );
...
//                 {/* Package Row Header */}
//                 <tr className="bg-gray-100">
//                   <td className="p-3 font-semibold text-[#212121]" colSpan={4}>
//                     <div className="flex justify-between items-center">
//                       <span className="text-lg">{pkg.packageName}</span>
//                       <button
//                         onClick={() => handleDeletePackage(pkg._id)}
...
//                         {/* indent empty cell */}
//                       </td>
//                       <td className="p-3 text-[#212121]">{repair.label}</td>
//                       <td className="p-3">
//                         {pkg.packageName === "Full Service" ? (
//                           <input
//                             type="number"
//                             value={repair.price}
//                             min={0}
//                             onChange={(e) =>
//                               handlePriceChange(pkg, idx, e.target.value)
//                             }
//                             className="w-24 p-1 border border-gray-300 rounded focus:outline-none focus:ring-2 focus:ring-red-400"
//                           />
//                         ) : (
//                           <input
//                             type="number"
//                             value={0}
//                             disabled
//                             className="w-24 p-1 border border-gray-300 rounded bg-gray-100 cursor-not-allowed"
//                             placeholder="N/A"
//                           />
//                           // or replace with:
